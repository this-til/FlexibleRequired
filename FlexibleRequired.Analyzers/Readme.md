...
### FlexibleRequired.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [FlexibleRequired.Sample.csproj](../FlexibleRequired.Sample/FlexibleRequired.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### FlexibleRequired.Tests
